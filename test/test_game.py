...
def test_2_players_always_raise_one_or_both_all_in(user_first: User, user_second: User, user_first_expected_balance: float, user_second_expected_balance: float):
    ...
    mock_deck.preset_turn(Card(Rank.SEVEN, Suit.CLUBS))
    mock_deck.preset_river(Card(Rank.ACE, Suit.HEARTS))

    player_first = BotPlayer(user_first, ChooseActionFactory.mock_choose_action_always_raise_if_possible)
    player_second = BotPlayer(user_second, ChooseActionFactory.mock_choose_action_always_raise_if_possible)
...
def test_3_players_always_raise(user_first: User, user_second: User, user_third: User,
    ...
    player_first = BotPlayer(user_first, ChooseActionFactory.mock_choose_action_always_raise_if_possible)
    player_second = BotPlayer(user_second, ChooseActionFactory.mock_choose_action_always_raise_if_possible)
    player_third = BotPlayer(user_third, ChooseActionFactory.mock_choose_action_always_raise_if_possible)
